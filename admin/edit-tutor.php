...
if(strlen($_SESSION['alogin'])==0){   
    ...
    if(isset($_POST['submit'])){
        ...
        $ret=mysqli_query($con,"update tutors set tutorName='$tutorname',tutorPhoto='$photo',email='$email'  where TutorRegno='$regid'");
        if($ret){
            $_SESSION['msg']="Tutors' records updated successfully!";
        }else{
            $_SESSION['msg']="Error : Tutors' records not updated!";
        }
    }
?>
...
<?php 
    $regid=intval($_GET['id']);
    $sql=mysqli_query($con,"select * from tutors where TutorRegno='$regid'");
    $cnt=1;
...
<div class="panel-body">
    <form name="dept" method="post" enctype="multipart/form-data">
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="tutorname" name="tutorname" value="<?php echo htmlentities($row['tutorName']);?>" autocomplete="off" />
        </div>
        <div class="form-group">
            <label for="email">E-mail </label>
            <input type="email" class="form-control" id="email" name="emailids" value="<?php echo htmlentities($row['email']); ?>" autocomplete="off" required />
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <label for="tutorphoto">Upload Photo  </label>
