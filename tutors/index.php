...
if(isset($_POST['submit'])){
    ...
    $query=mysqli_query($con,"SELECT * FROM tutors WHERE TutorRegno='$regno' and password='$password'");
...
<div class="content-wrapper">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h4 class="page-head-line">Tutors' Login </h4>
            </div>
        </div>
