        ...
        <td colspan="2">
            <table>
                <tr>
                    ...
                    <td>
                        <b> Turors' Number: </b><?php echo htmlentities($_SESSION['login']);?><br>
                        <b> Tutors' Name: </b>  <?php echo htmlentities($row['studentname']);?><br>
                        <b> Registraation Date:</b> <?php echo htmlentities($row['studentregdate']);?><br>
