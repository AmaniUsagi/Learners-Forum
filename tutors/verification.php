...
<div class="content-wrapper">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h1 class="page-head-line">Pincode Verification</h1>
            </div>
        </div>
        <div class="row" >
                            ...
                            <div class="panel-body">
                                <form name="pincodeverify" method="post">
                                    <div class="form-group">
                                        ...
                                        <input type="password" class="form-control" id="pincode" name="pincode" autocomplete="off" required />
                                    </div>
                                    <button type="submit" name="submit" class="btn btn-success center-block">Verify</button>
                                    <hr />
                                </form>
                            </div>
                        </div>
